...
@flavour/cli/0.7.7 darwin-x64 node-v10.15.3
...
_See code: [src/commands/add.ts](https://github.com/flavour/cli/blob/v0.7.7/src/commands/add.ts)_
...
_See code: [src/commands/check.ts](https://github.com/flavour/cli/blob/v0.7.7/src/commands/check.ts)_
...
_See code: [src/commands/remove.ts](https://github.com/flavour/cli/blob/v0.7.7/src/commands/remove.ts)_
