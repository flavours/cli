...
@flavour/cli/0.6.2 darwin-x64 node-v10.15.3
...
_See code: [src/commands/add.ts](https://github.com/flavour/cli/blob/v0.6.2/src/commands/add.ts)_
...
_See code: [src/commands/check.ts](https://github.com/flavour/cli/blob/v0.6.2/src/commands/check.ts)_
...
_See code: [src/commands/remove.ts](https://github.com/flavour/cli/blob/v0.6.2/src/commands/remove.ts)_
